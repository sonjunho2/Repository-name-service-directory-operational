...
function createImageUpload(multerImpl=require('multer')){
  // The installed Multer/Busboy stack emits LIMIT_FILE_SIZE when the byte
  // count reaches the configured value. Its exclusive runtime ceiling is one
  // byte above the public contract, which includes files of exactly 5MB.
